...
- [x] 다중 브라우저 세션 오염 및 레거시 로컬스토리지 격리 실패 버그 수정 (마이그레이션 폴백 제거 및 스토어 리셋) (@fe-dev, @qa-tester, 2026-05-29)
- [x] 백엔드 및 프론트엔드 팀 ID 일관성 불일치 버그 수정 (관리자 팀 생성 시 이름 반영, fetchMyTeam/fetchTeamMembers API 인자 일치 및 STOMP 웹소켓 토픽 teamId 단일화) (@fe-dev, @be-dev, @qa-tester, 2026-05-29)
